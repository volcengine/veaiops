...
::tabs
  ::tab{label="新建机器人"}
    ...
    ### 订阅事件
      ![配置引导](/veaiops/images/configurations-bot.png)
      ...
      ![订阅事件](/veaiops/images/configurations-bot-subscribe.png)
    ...
    ### 订阅回调：
      ...
      ![订阅回调](/veaiops/images/configurations-bot-callback.png)

    ### 配置权限
      在飞书开发者后台`权限管理`导入以下权限配置：
      ![权限管理](/veaiops/images/configurations-bot-auth.png)
      ```json
      {
        "scopes": {
          "tenant": [
