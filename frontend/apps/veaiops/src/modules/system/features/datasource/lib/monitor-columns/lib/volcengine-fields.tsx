 ...
 * @returns Volcengine specific field column array
 */
  ...
  return [
    {
      ...
      render: (_: unknown, record: DataSource) => {
        ...
        return <Ellipsis text={String(region)} center />;
      },
    },
    {
      title: '命名空间',
      ...
      render: (_: unknown, record: DataSource) => {
        ...
        return <Ellipsis text={String(namespace)} center />;
      },
    },
    {
      title: '子命名空间',
      ...
      render: (_: unknown, record: DataSource) => {
        const configData = getConfigData({ record, dsType: dataSourceType });
        const subNamespace =
          (configData as Record<string, unknown>)?.sub_namespace;
        return <Ellipsis text={String(subNamespace)} center />;
      },
    },
    {
      title: '实例列表',
