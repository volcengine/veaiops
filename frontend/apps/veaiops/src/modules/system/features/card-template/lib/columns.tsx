...
export const getCardTemplateColumns = (props: ColumnProps = {}) => {
  ...
  return [
    ...
    },
    {
      ...
      width: 150,
      render: (value: string) => {
        const typeKey = value as keyof typeof AGENT_TYPE_MAP;
        const agentInfo = AGENT_TYPE_MAP[typeKey];
        return (
          <CustomOutlineTag>
            {agentInfo?.label || value}
          </CustomOutlineTag>
        );
      },
    },
        ...
        <Space>
          <Tooltip content="编辑模版">
            <Button
              ...
              data-testid="edit-card-template-btn"
            >
              编辑
            </Button>
          </Tooltip>
          ...
          >
            <Tooltip content="删除模版">
              <Button
                ...
                status="danger"
                icon={<IconDelete />}
                data-testid="delete-card-template-btn"
              >
                删除
              </Button>
            </Tooltip>
