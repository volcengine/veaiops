...
/**
 * Form data initialization Hook parameters interface
 */
export interface UseFormInitializerParams {
  form: FormInstance;
  visible: boolean;
...
export const useFormInitializer = ({
  ...
  const initializeForm = useCallback(() => {
    ...
    try {
      ...
      // Silent handling: input autocomplete snapshot failure does not affect functionality
      const errorObj =
