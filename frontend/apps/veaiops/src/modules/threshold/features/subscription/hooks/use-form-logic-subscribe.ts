...
/**
 * Subscribe relation form logic Hook parameters interface
 */
export interface UseSubscribeRelationFormLogicParams {
  moduleType?: ModuleType;
}

/**
 * Subscribe relation form logic Hook
 * @param params Parameter object containing moduleType
 */
export const useSubscribeRelationFormLogic = ({
  moduleType,
}: UseSubscribeRelationFormLogicParams = {}) => {
