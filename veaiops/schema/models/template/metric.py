...
class MetricTemplateValue(BaseModel):
    ...
    normal_range_start: Optional[float] = Field(default=10.0, description="Normal Range Start")
    normal_range_end: Optional[float] = Field(default=90.0, description="Normal Range End")
